 ...
 * A dot/grid background whose dots reveal/expand toward the cursor (Clerk-style),
 * driven by a WebGL shader. Unchanged from the source except color defaults.
 */
